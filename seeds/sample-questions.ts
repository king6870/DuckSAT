...
<svg xmlns="http://www.w3.org/2000/svg" width="420" height="220" viewBox="0 0 420 220" role="img" aria-labelledby="title desc">
  ...
  <desc id="desc">Isosceles triangle ABC (AB = AC). Angle at A = 20 degrees. D is foot of altitude from A to BC.</desc>
  <style>
  ...
  <text class="label" x="215" y="75">20 deg</text>
  ...
  <text class="label" x="220" y="185">D</text>
    ...
    answerId: 'C',
    explanation:
      'Half the base is 8. Use Pythagorean theorem: AB = sqrt(8^2 + 12^2) = sqrt(64 + 144) = sqrt(208) = 4 * sqrt(13).',
...
<svg xmlns="http://www.w3.org/2000/svg" width="420" height="200" viewBox="0 0 420 200" role="img" aria-labelledby="title2 desc2">
  ...
  <text x="390" y="185" font-family="Arial" font-size="12">x</text>
    ...
    choices: [
      { id: 'A', text: '40' },
      { id: 'B', text: '60' },
      { id: 'C', text: '220/3 (approx 73.33)' },
      { id: 'D', text: '80' },
    ],
    answerId: 'C',
    explanation:
      'Solve 0.5x + 10 = -x + 120 -> 1.5x = 110 -> x = 110 / 1.5 = 220/3 which is approximately 73.33.',
