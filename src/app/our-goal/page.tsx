    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 text-center">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
          ...
          their family&apos;s income. That starts with affordable, high-quality test prep.
        </p>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-indigo-500">
            ...
            <p className="text-gray-600 text-sm">
              We&apos;re building the largest affordable SAT question bank on the internet. Currently at 5,400+ 
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-purple-500">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-gray-900">Affordable, Always</h3>
            </div>
            <p className="text-gray-600 text-sm">
              No overpriced plans. No freemium upsells. No hidden costs. DuckSAT will always be affordable. 
              We&apos;d rather help students than maximize profit.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-20">
        <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-3xl p-8 sm:p-12 shadow-2xl text-center">
          ...
          <p className="text-indigo-200 mb-8 max-w-lg mx-auto">
            Join thousands of students already using DuckSAT to prepare for the SAT. Affordable prep — always.
          </p>
          {session ? (
            <button
