        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className={`relative bg-white rounded-2xl shadow-xl border-2 transition-all hover:shadow-2xl ${
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-indigo-600 font-medium mt-1">1 month free trial</p>
            </div>
            ...
            <ul className="space-y-4 mb-8 flex-grow">
              ...
              <PricingFeature>Full progress tracking</PricingFeature>
              <PricingFeature>All question explanations</PricingFeature>
              <PricingFeature>1 month free trial</PricingFeature>
            </ul>
            ...
            {currentPlan === 'monthly' && isActive ? (
              ...
              <button
                ...
                className="w-full py-3 px-6 rounded-xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl"
              >
          ...
          <div className={`relative bg-white rounded-2xl shadow-lg border-2 transition-all hover:shadow-xl ${
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-amber-600 font-medium mt-1">Save $50 vs monthly</p>
            </div>
        ...
        <div className="mt-20 max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <FaqItem question="What happens when my free trial ends?">
              After your 30-day trial, you&apos;ll be automatically charged $25/month. You can cancel before the trial ends to avoid any charges.
            </FaqItem>
